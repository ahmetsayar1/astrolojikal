...
export function AnimeNavBar({ items, className, defaultActive = "Home" }: NavBarProps) {
  ...
  return (
    <motion.div 
      className={cn("flex items-center gap-1 sm:gap-2 bg-black/50 border border-white/10 backdrop-blur-lg py-2 px-2 rounded-full shadow-lg relative", className)}
      ...
      {items.map((item) => {
        ...
        return (
          <Link
            ...
            className={cn(
              "relative cursor-pointer text-sm font-semibold px-2 sm:px-4 md:px-6 py-3 rounded-full transition-all duration-300",
